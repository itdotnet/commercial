...
export function FileUploader({ imageUrl, onFieldChange, setFiles }: FileUploaderProps) {
    ...
    return (
        <>
            {imageUrl ? (
                <div
                    className="flex-center bg-dark-3 flex h-72 flex-col overflow-hidden rounded-xl bg-grey-50">
                    <input {...getInputProps()}/>
                    <div className="relative flex w-full flex-1 justify-center overflow-hidden">
                        ...
                        />
                        <div onClick={handleDeleteImage} className="absolute right-2 top-2 flex flex-col gap-4 rounded-xl bg-white p-3 shadow-sm transition-all cursor-pointer">
